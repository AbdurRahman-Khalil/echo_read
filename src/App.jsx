...
const App = () => {
  ...
  return (
    <>
      <header>
        <Navbar
          styles={"flex justify-between items-center border-b border-slate-900/70 dark:border-slate-50/75 px-3 pt-[0.4rem] pb-[0.3rem] fixed top-0 left-0 w-full z-50 bg-slate-50/35 dark:bg-slate-950/35 backdrop-blur-xl transition-all duration-500"}
        >
          ...
          <div className="flex gap-6 items-center">
            <form className="flex items-center border border-slate-900/30 dark:border-slate-50/30 pr-3 rounded-lg w-[22rem] bg-slate-50/10 dark:bg-slate-950/10 transition-all duration-500">
              <input className="px-3 py-[0.65rem] w-full outline-none rounded-s-lg text-[0.91rem] text-slate-800 dark:text-slate-100 font-semibold dark:font-medium backdrop-blur-xl bg-slate-50/35 dark:bg-slate-950/35" type="text" name="search" id="search" placeholder="Search Books" />
